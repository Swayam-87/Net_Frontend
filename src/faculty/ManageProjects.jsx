  ...
  const projects = [
    {
      ...
      description: 'A role-based Web API and React system for managing academic projects, task allocation, evaluation, and progress monitoring.',
    ...
    },
    {
      ...
      description: 'A high-throughput API gateway and storefront backend with inventory tracking.',
      student: 'Rohan Shah',
    ...
    },
    {
      ...
      description: 'A real-time home automation dashboard using MQTT and React.',
      student: 'Neha Mehta',
    ...
    <FacultyLayout>
      ...
      <div className="data-table-container">
        <div className="data-table-header">
          <span className="table-title">Supervised Project List</span>
        </div>
